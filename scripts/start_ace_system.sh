...
echo ""
echo "📡 服务地址："
echo "   - Next.js应用: http://0.0.0.0:3000"
echo "   - ACE API服务器: http://0.0.0.0:5001"
echo "   - 聊天页面: http://0.0.0.0:3000/chat"
echo ""
echo "🔗 API接口："
echo "   - 健康检查: http://0.0.0.0:5001/health"
echo "   - ACE聊天: http://0.0.0.0:5001/api/ace/chat"
echo "   - 知识库状态: http://0.0.0.0:5001/api/ace/playbook"
echo ""
