          ...
          <div>
            ...
            <p className="mb-6 text-pretty text-lg leading-relaxed text-muted-foreground">
              {language === "en"
                ...
                : "惜池集团是一家专业的英国移民服务供应商。我们致力于为您提供最专业、最高效、最安全的英国移民服务。凭借多年的经验和专业的顾问团队，我们帮助有才华的个人和企业家实现英国移民目标，提供包括创业签证、全球人才签证（GTV）、技术工作签证和其他英国移民解决方案在内的全方位服务。"}
            </p>
            <p className="mb-8 text-pretty text-lg leading-relaxed text-muted-foreground">
              {language === "en"
                ? "We combine traditional expertise with cutting-edge AI technology to provide accurate assessments, personalized guidance, and professional support throughout your immigration journey. Welcome to partner with Xichi Group to create a better future together. We look forward to providing you with the most professional, efficient, and secure UK immigration services."
                : "我们将传统专业知识与前沿AI技术相结合，为您提供准确的评估、个性化指导和专业支持，全程陪伴您的移民之路。欢迎您与惜池集团携手合作，共创美好未来。我们期待为您提供最专业、最高效、最安全的英国移民服务。"}
            </p>
