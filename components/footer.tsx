    ...
    <footer className="border-t border-border bg-muted/30">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mb-4 text-sm leading-relaxed text-muted-foreground">
              {language === "en"
                ? "Professional UK immigration service provider. We provide the most professional, efficient, and secure UK immigration services. Welcome to partner with Xichi Group to create a better future together."
                : "专业的英国移民服务供应商。我们提供最专业、最高效、最安全的英国移民服务。欢迎您与惜池集团携手合作，共创美好未来。"}
            </p>
        ...
        <div className="mt-12 border-t border-border pt-8 text-center text-sm text-muted-foreground">
          <p>
            © {new Date().getFullYear()} {language === "en" ? "Xichi Group" : "惜池集团"}.{" "}
            {language === "en"
